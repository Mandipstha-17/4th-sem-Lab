    ...
    for (i = 0; str[i] != '\0'; i++) {
        ...
        for (j = 0; j < currentStateCount; j++) {
            switch (currentStates[j]) {
                case 0:
                    if (str[i] == 'm') nextStates[nextStateCount++] = 1;
                    break;
                case 1:
                    if (str[i] == 'a') nextStates[nextStateCount++] = 2;
                    break;
                case 2:
                    if (str[i] == 'n') nextStates[nextStateCount++] = 3;
                    break;
                case 3:
                    if (str[i] == 'd') nextStates[nextStateCount++] = 4;
                    break;
                case 4:
                    if (str[i] == 'i') nextStates[nextStateCount++] = 5;
                    break;
                case 5:
                    if (str[i] == 'p') nextStates[nextStateCount++] = 6;
                    break;
                case 6:
                    break;
            }
